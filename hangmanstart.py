...
potential_words = ["think", "quark", "waxed", "yellow", "broken"]
...
while fails < maxfails:
    ...
    # display and winning need to be in the while loop (on top) so it  resets to empty string as rerun the for loops
    display = ""
    winning = ""
    ...
    if winning == word:
        print("you won")
        exit(0) #stops the program and runs nothing else
